...
public class ViewPost extends GeneralServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		out.println(
				...
				+ "<body>"
				+ "<h2 align=\"center\"></h2>"
				+ "<form method=\"post\" action=\"/blog/ViewPost\">"
				...
				+ " <br />"
				 +cont+" </p>"
				+ "</div>");
		Iterator<Comentario> it = p.getComentarios().iterator();
		while (it.hasNext())
		out.println(it.next().getConteudo());
